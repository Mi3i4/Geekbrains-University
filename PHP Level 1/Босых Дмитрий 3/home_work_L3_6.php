...
<head>
	...
	<link rel="stylesheet" href="minimalistica/css/main.css" type="text/css" />
...
<body>
	...
	<div id="content">
	<div class="logo">
		 <div class="name"><h1><?php echo $h1;?></h1></div>
		 <div class="date"><?php echo date('l jS \of F H:i:s');?></div>
		 </div>
...
//                $array_sub_menu = ['about', 'news', 'map'];
		...
		<div id="footer">
			<p>Copyright &copy; <em>minimalistica</em> &middot; Design: Luka Cvrk, <a href="http://www.solucija.com/" title="Free CSS Templates">Solucija</a><?php echo date(' Y');?></p>
		</div>
	</div>
</body>
</html>