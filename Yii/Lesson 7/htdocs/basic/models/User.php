...
class User extends \yii\db\ActiveRecord implements \yii\web\IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['create_date'], 'safe'],
            [['username', 'name', 'password', 'salt', 'access_token'], 'string', 'max' => 255],
            [['username'], 'unique'],
            [['access_token'], 'unique'],
            [['username'], 'email'],
    ...
    {
        return hash("md5", uniqid('salt_', true));
    }
    /**
...
//        $msg_html .= "<h2 style='font-weight:bold;border-bottom:1px dotted #ccc;'>Здравствуйте! Благодарим за оформление подписки на сайте <a href='". $absoluteHomeUrl ."'>$serverName</a></h2>\r\n";
